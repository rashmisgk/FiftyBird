...
local GAP_HEIGHT = 0 --size of the gaps between the pipes
local GAP_HEIGHT_MIN = 60 --min size of the gaps between the pipes
local GAP_HEIGHT_MAX = 120 --max size of the gaps between the pipes
...
function PipePair:init(y)
    ...
    --randomely generating a number between 60 to 120 for the gap between pipes
